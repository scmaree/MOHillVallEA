...
/*
 ...
 iAMaLGaM as part of MO-HillVallEA
...
hillvallea::iamalgam_t::iamalgam_t(fitness_pt fitness_function, rng_pt rng, bool use_univariate) : cluster_t(fitness_function, rng)
{
  terminated = false;
  multiplier = 1.0;
...
hillvallea::iamalgam_t::iamalgam_t(const iamalgam_t & other) : cluster_t(other)
{
...
size_t hillvallea::iamalgam_t::recommended_popsize(size_t number_of_parameters) const
{
...
// Algorithm Name
std::string hillvallea::iamalgam_t::name() const
{ 
  if (use_univariate)
...
bool hillvallea::iamalgam_t::adaptDistributionMultiplier(const elitist_archive_t & elitist_archive, size_t & no_improvement_stretch, const size_t maximum_no_improvement_stretch)
{
...
void hillvallea::iamalgam_t::estimateParameters()
{
  ...
  else
  {
    ...
    {  // full
      compute_covariance(true_mean, generational_covariance);
    }
  }
...
* and returned.
*/
bool hillvallea::iamalgam_t::generationalImprovementForOneCluster(double & st_dev_ratio, const elitist_archive_t & elitist_archive) const
{
...
// Compute the SDR
//--------------------------------------------------------------------------------------
double hillvallea::iamalgam_t::getSDR(const vec_t & params) const
{
...
////------------------------------------------------------------------------
void hillvallea::iamalgam_t::apply_ams(std::vector<solution_pt> & solutions, const size_t number_of_elites, const size_t number_of_ams_solutions, const double ams_factor, const vec_t & ams_direction, const vec_t & lower_param_bounds, const vec_t & upper_param_bounds) const
{
...
bool hillvallea::iamalgam_t::updateStrategyParameters(const elitist_archive_t & elitist_archive, size_t & no_improvement_stretch, const size_t maximum_no_improvement_stretch)
{
...
void hillvallea::iamalgam_t::computeParametersForSampling()
{
...
void hillvallea::iamalgam_t::generateNewSolutions(std::vector<solution_pt> & solutions, size_t number_of_solutions, size_t number_of_ams_solutions, rng_pt & rng)
{
...
hillvallea::vec_t hillvallea::iamalgam_t::getVec(std::string variable_name)
{
...
double hillvallea::iamalgam_t::getDouble(std::string variable_name)
{
...
hillvallea::matrix_t hillvallea::iamalgam_t::getMatrix(std::string variable_name)
{
